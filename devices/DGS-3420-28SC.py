...
DeviceMap = ([
    ...
    [
	['4/1','4/3','4/5','4/7','4/9', '4/11','4/13','4/15','4/17','4/19','4/21','4/23','4/25','4/27'],
	['4/2','4/4','4/6','4/8','4/10','4/12','4/14','4/16','4/18','4/20','4/22','4/24','4/26','4/28']
    ],
    [
	['5/1','5/3','5/5','5/7','5/9', '5/11','5/13','5/15','5/17','5/19','5/21','5/23','5/25','5/27'],
	['5/2','5/4','5/6','5/8','5/10','5/12','5/14','5/16','5/18','5/20','5/22','5/24','5/26','5/28']
    ],
    [
	['6/1','6/3','6/5','6/7','6/9', '6/11','6/13','6/15','6/17','6/19','6/21','6/23','6/25','6/27'],
...
PortName = ({
    ...
    '27' : '1/27',  '91' : '2/27',  '155' : '3/27',  '219' : '4/27',  '283' : '5/27',  '347' : '6/27',
    '28' : '1/28',  '92' : '2/28',  '156' : '3/28',  '220' : '4/28',  '284' : '5/28',  '348' : '6/28',
    },)
...
walk_PortIndex = {
#    PortIndex           .1.3.6.1.4.1.171.11.118.2.2.3.1.1.1		swL2PortInfoPortIndex
    'PortIndex'       : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1',
    }
...
get_PortIndex = {
#    PortIndex           .1.3.6.1.4.1.171.11.118.2.2.3.1.1.1		swL2PortInfoPortIndex
    'PortIndex..1'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.1.2',
    'PortIndex..2'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.2.2',
    'PortIndex..3'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.3.2',
    'PortIndex..4'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.4.2',
    'PortIndex..5'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.5.2',
    'PortIndex..6'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.6.2',
    'PortIndex..7'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.7.2',
    'PortIndex..8'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.8.2',
    'PortIndex..9'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.9.2',
    'PortIndex..10'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.10.2',
    'PortIndex..11'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.11.2',
    'PortIndex..12'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.12.2',
    'PortIndex..13'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.13.2',
    'PortIndex..14'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.14.2',
    'PortIndex..15'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.15.2',
    'PortIndex..16'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.16.2',
    'PortIndex..17'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.17.2',
    'PortIndex..18'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.18.2',
    'PortIndex..19'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.19.2',
    'PortIndex..20'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.20.2',
    'PortIndex..21c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.21.1',
    'PortIndex..21f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.21.2',
    'PortIndex..22c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.22.1',
    'PortIndex..22f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.22.2',
    'PortIndex..23c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.23.1',
    'PortIndex..23f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.23.2',
    'PortIndex..24c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.24.1',
    'PortIndex..24f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.24.2',
    'PortIndex..25'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.25.2',
    'PortIndex..26'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.26.2',
    'PortIndex..27'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.27.2',
    'PortIndex..28'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.1.28.2',
    }

get_SinglePort = {
#    MediumType          .1.3.6.1.4.1.171.11.118.2.2.3.1.1.2		swL2PortInfoMediumType
    'MediumType..c'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.2.%s.1',
    'MediumType..f'   : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.2.%s.2',
#    ActualStatus        .1.3.6.1.4.1.171.11.118.2.2.3.1.1.5		swL2PortInfoLinkStatus
    'ActualStatus..c' : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.5.%s.1',
    'ActualStatus..f' : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.5.%s.2',
#    ActualSpeed         .1.3.6.1.4.1.171.11.118.2.2.3.1.1.6		swL2PortInfoNwayStatus
    'ActualSpeed..c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.6.%s.1',
    'ActualSpeed..f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.6.%s.2',
#    AdminStatus         .1.3.6.1.4.1.171.11.118.2.2.3.2.1.4		swL2PortCtrlAdminState
    'AdminStatus..c'  : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.4.%s.1',
    'AdminStatus..f'  : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.4.%s.2',
#    AdminSpeed          .1.3.6.1.4.1.171.11.118.2.2.3.2.1.5		swL2PortCtrlNwayState
    'AdminSpeed..c'   : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.5.%s.1',
    'AdminSpeed..f'   : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.5.%s.2',
#    AdminFlow           .1.3.6.1.4.1.171.11.118.2.2.3.2.1.6		swL2PortCtrlFlowCtrlState
    'AdminFlow..c'    : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.6.%s.1',
    'AdminFlow..f'    : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.6.%s.2',
...
walk_AllPorts = {
#    MediumType          .1.3.6.1.4.1.171.11.118.2.2.3.1.1.2		swL2PortInfoMediumType
    'MediumType'      : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.2',
#    ActualStatus        .1.3.6.1.4.1.171.11.118.2.2.3.1.1.5		swL2PortInfoLinkStatus
    'ActualStatus'    : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.5',
#    ActualSpeed         .1.3.6.1.4.1.171.11.118.2.2.3.1.1.6		swL2PortInfoNwayStatus
    'ActualSpeed'     : '.1.3.6.1.4.1.171.11.118.2.2.3.1.1.6',
#    AdminStatus         .1.3.6.1.4.1.171.11.118.2.2.3.2.1.4		swL2PortCtrlAdminState
    'AdminStatus'     : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.4',
#    AdminSpeed          .1.3.6.1.4.1.171.11.118.2.2.3.2.1.5		swL2PortCtrlNwayState
    'AdminSpeed'      : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.5',
#    AdminFlow           .1.3.6.1.4.1.171.11.118.2.2.3.2.1.6		swL2PortCtrlFlowCtrlState
    'AdminFlow'       : '.1.3.6.1.4.1.171.11.118.2.2.3.2.1.6',
    }
