...
# SlotSize - количество индексов, отведенное на слот. Обычно это 64, то есть слот №1 - 1..64,
# слот №2 - 65..128, слот №3 - 129..192 и так далее.
...
get_SinglePort = {
    ...
    #    PortType            .1.3.6.1.4.1.171.11.113.5.1.2.3.1.1.4		swL2PortInfoType
    'PortType..c': '.1.3.6.1.4.1.171.11.113.5.1.2.3.1.1.4.%s.1',
    'PortType..f': '.1.3.6.1.4.1.171.11.113.5.1.2.3.1.1.4.%s.2',
    #    PortName            .1.3.6.1.2.1.31.1.1.1.1			ifName
...
walk_syslog = {
    ...
    'SysLogServerSeverity': '1.3.6.1.4.1.171.12.12.2.1.4', #3 - information
